...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.ModelRobot = QtWidgets.QComboBox(self.frame)
        self.ModelRobot.setObjectName("ModelRobot")
        self.ModelRobot.addItem("")
        self.ModelRobot.addItem("")
        self.ModelRobot.addItem("")
        self.ModelRobot.addItem("")
        self.ModelRobot.addItem("")
        self.ModelRobot.addItem("")
        self.horizontalLayout_7.addWidget(self.ModelRobot)
        ...
        self.SimulationCheckBox = QtWidgets.QCheckBox(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SimulationCheckBox.sizePolicy().hasHeightForWidth())
        self.SimulationCheckBox.setSizePolicy(sizePolicy)
        self.SimulationCheckBox.setText("")
        self.SimulationCheckBox.setTristate(False)
        self.SimulationCheckBox.setObjectName("SimulationCheckBox")
        self.horizontalLayout_8.addWidget(self.SimulationCheckBox)
        ...
        self.SimulationCheckBox.stateChanged['int'].connect(lambda a: self.IpLineEdit.setEnabled(not a))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_15.setText(_translate("MainWindow", "Модель робота:"))
        self.ModelRobot.setItemText(0, _translate("MainWindow", "rs007l"))
        self.ModelRobot.setItemText(1, _translate("MainWindow", "rs007n"))
        self.ModelRobot.setItemText(2, _translate("MainWindow", "rs013n"))
        self.ModelRobot.setItemText(3, _translate("MainWindow", "rs020n"))
        self.ModelRobot.setItemText(4, _translate("MainWindow", "rs025n"))
        self.ModelRobot.setItemText(5, _translate("MainWindow", "rs080n"))
        self.label_17.setText(_translate("MainWindow", "Симуляция:"))
        self.label_12.setText(_translate("MainWindow", "IP адрес робота:"))
        self.IpLineEdit.setText(_translate("MainWindow", "196.001.1.1"))
